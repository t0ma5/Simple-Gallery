...
- FOSS Photo Editor: crop, rotate, resize, draw, filters, tone sliders, text and emoji stickers. There is no proprietary photo-editor SDK.
...
- applicationId and Kotlin packages are `tomato.simple.gallery`, so it can sit next to Simple Gallery Pro.
