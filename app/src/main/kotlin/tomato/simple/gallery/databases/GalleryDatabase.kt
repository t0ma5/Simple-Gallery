package tomato.simple.gallery.databases
...
import tomato.simple.gallery.interfaces.*
import tomato.simple.gallery.models.*

@Database(entities = [Directory::class, Medium::class, Widget::class, DateTaken::class, Favorite::class, MediaTag::class], version = 11)
abstract class GalleryDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("CREATE TABLE IF NOT EXISTS `media_tags` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `full_path` TEXT NOT NULL, `tag` TEXT NOT NULL)")
                database.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_media_tags_full_path_tag` ON `media_tags` (`full_path`, `tag`)")
            }
        }
    }
}
