...
import tomato.simple.gallery.adapters.DirectoryAdapter
import tomato.simple.gallery.databases.GalleryDatabase
import tomato.simple.gallery.databinding.ActivityMainBinding
import tomato.simple.gallery.dialogs.ChangeSortingDialog
import tomato.simple.gallery.dialogs.ChangeViewTypeDialog
import tomato.simple.gallery.dialogs.FilterMediaDialog
import tomato.simple.gallery.dialogs.GrantAllFilesDialog
import tomato.simple.gallery.extensions.*
import tomato.simple.gallery.helpers.*
import tomato.simple.gallery.interfaces.DirectoryOperationsListener
...
class MainActivity : SimpleActivity(), DirectoryOperationsListener {
     ...
     * shallowest root so Camera/Screenshots are not a flat grid. Favorites and Recycle Bin
     * stay at depth 0. A visited set stops path cycles from overflowing the stack.
     */
    private fun getTreeDirectories(dirs: ArrayList<Directory>): ArrayList<Directory> {
        val byPath = LinkedHashMap<String, Directory>()
        dirs.filter { it.path.isNotEmpty() }.forEach { dir ->
        ...
        val result = ArrayList<Directory>(byPath.size)
